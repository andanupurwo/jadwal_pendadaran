...
export const ROOMS = ['6.3.A', '6.3.B', '6.3.C', '6.3.D', '6.3.E', '6.3.F', '6.3.G', '6.3.H'];

export const TIMES = ['08:30', '10:00', '11:30', '13:30'];
...
export const DATA_PATHS = {
    SDM: '/src/assets/data/Data pegawai - DAAK.csv',
    FACULTY: '/src/assets/data/Dosen Prodi.csv'
};
